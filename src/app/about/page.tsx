            ...
            <section className="mb-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {teamMembers.map((member) => (
                  <Card key={member.name} hoverable className="flex flex-col justify-between min-h-[180px]">
                    <div className="mb-4">
          ...
          <SectionReveal>
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {offices.map((office) => (
                  <Card key={office.branch} hoverable className="flex flex-col justify-between min-h-[200px]">
                    <div>
